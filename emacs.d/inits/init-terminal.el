...
(use-package ghostel
  ...
  (define-key ghostel-mode-map [f7]  'laura/tabspaces-kill-buffers-close-workspace-confirm)
...
(use-package vterm
  ...
  (define-key vterm-mode-map [f7]  'laura/tabspaces-kill-buffers-close-workspace-confirm)
