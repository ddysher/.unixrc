...
(custom-set-variables
 ...
 '(package-selected-packages
   '(ag apache-mode cape consult corfu dockerfile-mode doom-themes
        embark embark-consult exec-path-from-shell flycheck ggtags
        go-mode gptel hackernews js2-mode lua-mode magit marginalia
        markdown-mode matlab-mode multi-vterm neotree nginx-mode
        orderless pet php-mode protobuf-mode pyim pyim-basedict
        rust-mode sbt-mode scala-mode tempel thrift vertico vterm
        web-mode window-numbering wsd-mode yaml-mode))
